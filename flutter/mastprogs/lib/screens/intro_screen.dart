                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                              '생산성 향상이나 코드 리팩토링, 또는 새롭고 도전적인 문제를 고민하고 해결하는 것을 좋아합니다.')
                        ],
                      ),
                    )
                  ],
              ...
              Padding(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    //   titleSize: 20,
                    //   desc:
                    //       '불필요한 야근을 지양하는 편입니다. 작업상황에 따른 일이 몰려 야근하거나, 개인적인 성취 욕구에 야근을 하게 되는 경우가 있기에, 언제나 구성원 역할에 있어 항상 최선을 다합니다. 하지만 야근의 종류가 모호한 지시사항이나, 비효율적인 프로세스, 비정상적인 일정산정에 따른 경우라면 제가 추구하는 업무 환경은 아닙니다. 적당한 개인적인 시간이 주어져야 자기계발도 가능하고, 지속적인 자기계발이 저의 성장과 더불어 회사도 함께 성장할 수 있는 발판이 마련된다고 생각하기 때문입니다. 상황상 어쩔수 없이 팀 모두 함께 해야하는 경우에 대해 부정하지는 않으나, 개인의 성과는 곧 야근이라고 당연시 생각하는 가치관은 저와 반대됩니다. 지속적인 야근은 저 스스로의 퍼포먼스를 높게 유지하기 어렵게 만들고 회사의 성장에도 기여하기 어려운 점을 잘 알고 있기 때문입니다.',
                    // ),
                    SizedBox(height: 40),
                    DescriptionBox(
